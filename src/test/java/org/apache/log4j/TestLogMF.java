...
public class TestLogMF {
     ...
     * Logger.
     */
    private final Logger logger = Logger.getLogger("org.apache.log4j.formatter.TestLogMF");
	...
	MessageFormat formatter = new MessageFormat("Iteration {0}", Locale.getDefault());
	String expected = formatter.format(new Object[] { (float) Math.PI });
	...
	MessageFormat formatter = new MessageFormat("Iteration {0}", Locale.getDefault());
	String expected = formatter.format(new Object[] { Math.PI });
	assertEquals(expected, capture.getMessage());
    }
	...
	String expected = MessageFormat.format("Iteration {0}", new Object[] { epoch });
	...
	String expected = java.text.MessageFormat.format("{0}{0, number, percent}", new Object[] { Math.PI });
	assertEquals(expected, capture.getMessage());
    }
     ...
     */
    private static final String BUNDLE_NAME = "org.apache.log4j.TestLogMFPatterns";
	...
	LogCapture capture = new LogCapture(Level.ERROR);
	LogMF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello4", "World", "Hello");
	assertEquals("Hello, World.", capture.getMessage());
    }
	...
	LogCapture capture = new LogCapture(Level.ERROR);
	LogMF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello5", "World", "Hello", ",");
	assertEquals("Hello, World.", capture.getMessage());
    }
	...
	LogCapture capture = new LogCapture(Level.ERROR);
	LogMF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello6", "World", "Hello", ",", ".");
	assertEquals("Hello, World.", capture.getMessage());
    }
	...
	LogCapture capture = new LogCapture(Level.ERROR);
	Object[] args = new Object[] { "World", "Hello", ",", "." };
	LogMF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello6", args);
	assertEquals("Hello, World.", capture.getMessage());
    }
	...
	LogMF.info(logger, "{1}, {9}{0}",
		new Object[] { "World", "Hello", null, null, null, null, null, null, null, "New " });
