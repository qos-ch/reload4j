...
public class NameAbbreviatorTest extends TestCase {
    ...
    /**
     * Check that getAbbreviator("1.*.2").abbreviate drops all but the first character from the first element, uses all
     * of the second element and drops all but the first two characters of the rest of the non-final elements.
     */
