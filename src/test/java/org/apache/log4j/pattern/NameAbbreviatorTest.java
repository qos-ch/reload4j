...
public class NameAbbreviatorTest extends TestCase {
    ...
    /**
     * Check that getAbbreviator("1").abbreviate() drops all but the final name
     * element.
     *
     */
    public void testOne() {
    ...
    /**
     * Check that getAbbreviator("2").abbreviate drops all but the last two
     * elements.
     *
     */
    public void testTwo() {
    ...
    /**
     * Check that getAbbreviator("1.").abbreviate abbreviates non-final elements to
     * one character.
     *
     */
     ...
     * character from the first element, uses all of the second element and drops
     * all but the first two characters of the rest of the non-final elements.
     *
     */
