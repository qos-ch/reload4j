...
public class DOMTestCase {
    ...
    /**
     * Tests that loggers mentioned in logger elements use the specified
     * categoryFactory. See bug 33708.
     */
    ...
    /**
     * Tests that loggers mentioned in logger-ref elements use the specified
     * categoryFactory. See bug 33708.
     */
    @Test
    ...
    /**
     * Tests that reset="true" on log4j:configuration element resets repository
    ...
    /**
     * This test checks that the subst method of an extending class is checked when
     * evaluating parameters. See bug 43325.
     *
     */
