...
public class TestLogSF extends TestCase {
     ...
     * Logger.
     */
    private final Logger logger = Logger.getLogger("org.apache.log4j.formatter.TestLogSF");
     ...
     */
    private static final String BUNDLE_NAME = "org.apache.log4j.TestLogSFPatterns";
    ...
    public void testLogrbFloat() {
        LogCapture capture = new LogCapture(Level.ERROR);
        LogSF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Iteration0", (float) Math.PI);
    ...
    public void testLogrbTwoArg() {
        LogCapture capture = new LogCapture(Level.ERROR);
        LogSF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello4", "Hello", "World");
        assertEquals("Hello, World.", capture.getMessage());
    }
    ...
    public void testLogrbThreeArg() {
        LogCapture capture = new LogCapture(Level.ERROR);
        LogSF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello5", "Hello", ",", "World");
        assertEquals("Hello, World.", capture.getMessage());
    }
    ...
    public void testLogrbFourArg() {
        LogCapture capture = new LogCapture(Level.ERROR);
        LogSF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello6", "Hello", ",", "World", ".");
        assertEquals("Hello, World.", capture.getMessage());
    }
    ...
    public void testLogrbArrayArg() {
        LogCapture capture = new LogCapture(Level.ERROR);
        Object[] args = new Object[] { "Hello", ",", "World", "." };
        LogSF.logrb(logger, Level.ERROR, BUNDLE_NAME, "Hello6", args);
        assertEquals("Hello, World.", capture.getMessage());
    }
