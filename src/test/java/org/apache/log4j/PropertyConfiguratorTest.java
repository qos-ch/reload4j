...
public class PropertyConfiguratorTest extends TestCase {
    ...
    /**
     * Test for bug 40944. Did not catch IllegalArgumentException on Properties.load
    ...
    /**
     * Test for bug 40944. configure(URL) did not catch IllegalArgumentException and
	...
	RollingFileAppender rfa = (RollingFileAppender) Logger.getLogger("org.apache.log4j.PropertyConfiguratorTest")
		.getAppender("ROLLING");
	...
	zos.closeEntry();
	zos.close();
	URL url = new URL("jar:" + file.toURL() + "!/" + LogManager.DEFAULT_CONFIGURATION_FILE);
	PropertyConfigurator.configure(url);
	assertTrue(file.delete());
	assertFalse(file.exists());
    }
    ...
    /**
     * Mock definition of org.apache.log4j.rolling.RollingPolicy from extras
     * companion.
     */
    ...
    /**
     * Mock definition of org.apache.log4j.rolling.RollingFileAppender from extras
     * companion.
     */
