...
public class LevelTest extends TestCase {
	...
	int[] skip = new int[] {};
	SerializationTestHelper.assertSerializationEquals(TEST_WITNESS_PREFIX + "serialization/info.bin", Level.INFO,
	...
	Object obj = SerializationTestHelper.deserializeStream(TEST_WITNESS_PREFIX + "serialization/info.bin");
