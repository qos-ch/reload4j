 ...
 *
 * <p>
 * In this case MyPatternLayout recognizes %# conversion pattern. It outputs the value of an internal counter which is
 * also incremented at each call.
 *
 * <p>
 * See <a href=doc-files/MyPatternLayout.java><b>source</b></a> code for more details.
 *
...
public class EnhancedMyPatternLayout extends EnhancedPatternLayout {
    ...
    public EnhancedMyPatternLayout(String pattern) {
        super(pattern);
    }
