...
/**
 * Render {@link ThreadGroup} objects in a format similar to the information
 * output by the {@link ThreadGroup#list} method.
 * 
...
public class ThreadGroupRenderer implements ObjectRenderer {
     ...
     * 
     * <p>
     * The output of a simple program consisting of one <code>main</code> thread is:
     * 
     * <pre>
