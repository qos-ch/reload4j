...
public class RendererMap {
     ...
     *
     * <p>
     * The search first looks for a renderer configured for <code>clazz</code>. If a renderer could not be found, then
     ...
     *
     * <p>
     * The table below shows the results returned by the <code>get(A2.class)</code> method depending on the renderers
     * added to the map.
     *
     * <p>
     * <table border="1">
