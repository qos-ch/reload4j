...
public class LoggingEvent implements java.io.Serializable {
    ...
    /**
     * This removes the specified MDC property from the event. Access to the MDC is not synchronized, so this method
     * should only be called when it is known that no other threads are accessing the MDC.
     *
