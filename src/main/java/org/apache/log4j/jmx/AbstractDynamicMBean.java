...
public abstract class AbstractDynamicMBean implements DynamicMBean, MBeanRegistration {
	...
	if (name == null || name.trim().length() == 0) {
	    // try to get some form of a name, because null is not allowed (exception), and
	    // empty string certainly isn't useful in JMX..
    ...
    /**
     * Registers MBean instance in the attached server. Must <em>NOT</em> be called
     * before registration of this instance.
     */
