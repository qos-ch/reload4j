...
public class HierarchyDynamicMBean extends AbstractDynamicMBean
	...
	vAttributes.add(new MBeanAttributeInfo(THRESHOLD, "java.lang.String",
		"The \"threshold\" state of the hiearchy.", true, true, false));
	...
	dOperations[0] = new MBeanOperationInfo("addLoggerMBean", "addLoggerMBean(): add a loggerMBean", params,
		"javax.management.ObjectName", MBeanOperationInfo.ACTION);
    }
	...
	return new MBeanInfo(dClassName, dDescription, attribs, dConstructors, dOperations,
