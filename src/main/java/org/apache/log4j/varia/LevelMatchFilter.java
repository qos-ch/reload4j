...
public class LevelMatchFilter extends Filter {
     ...
     * <p>
     * Returns {@link Filter#NEUTRAL} if the <b>LevelToMatch</b> option is not set or if there is not match. Otherwise,
     * if there is a match, then the returned decision is {@link Filter#ACCEPT} if the <b>AcceptOnMatch</b> property is
     * set to <code>true</code>. The returned decision is {@link Filter#DENY} if the
