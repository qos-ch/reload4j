 ...
 * default "accept all unless instructed otherwise" filtering behaviour to a
 * "deny all unless instructed otherwise" behaviour.
 * 
 * 
...
public class DenyAllFilter extends Filter {
    ...
    /**
     * Always returns the integer constant {@link Filter#DENY} regardless of the
     * {@link LoggingEvent} parameter.
     * 
