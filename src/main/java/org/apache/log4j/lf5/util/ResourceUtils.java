...
public class ResourceUtils {
    ...
    /**
     * Get the InputStream for this resource. Note: to convert an InputStream into
     * an InputReader, use: new InputStreamReader(InputStream).
     *
     * @param object   The object to grab the Classloader from. This parameter is
     *                 quite important from a visibility of resources standpoint as
     *                 the hierarchy of Classloaders plays a role.
     *
