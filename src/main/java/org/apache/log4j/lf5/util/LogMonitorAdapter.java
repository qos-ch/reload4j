...
public class LogMonitorAdapter {
    ...
    /**
     * <p>
     * Creates an instance of LogMonitorAdapter using the log levels inticated by
     * the parameter. Log4J and JDK1.4 both have default LogLevels which are set but
     * these levels can be overriden.
     * <p>
     *
     * @param loglevels An integer representing either Log4J or JDK1.4 logging
     *                  levels
    ...
    /**
     * <p>
     * Creates an instance of LogMonitorAdapter using the specified LogLevels. The
     * first LogLevel in the array is used as the default LogLevel unless changed
     * using the setDefaultLevel method.
     * <p>
     *
     ...
     * <p>
     * Creates an instance of LogMonitorAdapter using the specified LogLevels. The
     * first LogLevel in the List is used as the default LogLevel unless changed
     * using the setDefaultLevel method.
     * <p>
     *
    ...
    /**
     * <p>
     * Set the default log level to be used when logging messages without specifying
     * a LogLevel.
     * <p>
     *
     * @param level
