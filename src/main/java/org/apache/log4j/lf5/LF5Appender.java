...
/**
 * <code>LF5Appender</code> logs events to a swing based logging console. The
 * swing console supports turning categories on and off, multiple detail level
...
public class LF5Appender extends AppenderSkeleton {
    ...
    /**
     * Constructs a <code>LF5Appender</code> using the default instance of the
     * <code>LogBrokerMonitor</code>. This constructor should <bold>always </bold>
    ...
    /**
     * Constructs a <code>LF5Appender<code> using an instance of a
     * <code>LogBrokerMonitor<code> supplied by the user. This constructor should
     * only be used when you need to spawn additional log monitoring windows.
     *
     * @param monitor An instance of a <code>LogBrokerMonitor<code> created by the
     *                user.
     */
    ...
    /**
     * This method is an empty implementation of the close() method inherited from
     * the <code>org.apache.log4j.Appender</code> interface.
     */
    public void close() {
    }
     ...
     * <code>Layout</code>. This method always returns false. No layout is required
     * for the <code>LF5Appender</code>.
     */
    ...
    /**
     * This method is used to set the property that controls whether the
     * <code>LogBrokerMonitor</code> is hidden or closed when a user exits the
     * monitor. By default, the <code>LogBrokerMonitor</code> will hide itself when
     * the log window is exited, and the swing thread will continue to run in the
     * background. If this property is set to true, the
     * <code>LogBrokerMonitor</code> will call System.exit(0) and will shut down
     * swing thread and the virtual machine.
     *
     * @param callSystemExitOnClose A boolean value indicating whether to call
     *                              System.exit(0) when closing the log window.
     */
    ...
    /**
     * The equals method compares two LF5Appenders and determines whether they are
     * equal. Two <code>Appenders</code> will be considered equal if, and only if,
     * they both contain references to the same <code>
     * LogBrokerMonitor</code>.
     *
     * @param compareTo A boolean value indicating whether the two LF5Appenders are
     *                  equal.
     */
    ...
    /**
     * @return the screen width from Toolkit.getScreenSize() if possible, otherwise
     *         returns 800
    ...
    /**
     * @return the screen height from Toolkit.getScreenSize() if possible, otherwise
     *         returns 600
     * @see java.awt.Toolkit
     */
