...
public class LogLevel implements java.io.Serializable {
	...
	_allDefaultLevels = new LogLevel[] { FATAL, ERROR, WARN, INFO, DEBUG, SEVERE, WARNING, CONFIG, FINE, FINER,
		FINEST };
    ...
    /**
     * Returns true if the level supplied is encompassed by this level. For example,
     * LogLevel.SEVERE encompasses no other LogLevels and LogLevel.FINE encompasses
     * all other LogLevels. By definition, a LogLevel encompasses itself.
     */
     ...
     * @throws LogLevelFormatException Is thrown when the level can not be converted
     *                                 into a LogLevel.
     */
    ...
    /**
     * @return A <code>List</code> of <code>LogLevel</code> objects that map to
     *         log4j <code>Priority</code> objects.
     */
