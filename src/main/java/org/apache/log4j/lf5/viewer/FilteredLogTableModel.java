...
public class FilteredLogTableModel extends AbstractTableModel {
    ...
    protected String[] _colNames = { "Date", "Thread", "Message #", "Level", "NDC", "Category", "Message", "Location",
	    "Thrown" };
    ...
    /**
     * Forces the LogTableModel to requery its filters to determine which records to
     * display.
     */
