...
public class CategoryNodeEditor extends CategoryAbstractCellEditor {
	...
	JOptionPane.showMessageDialog(_tree, getDisplayedProperties(node), "Category Properties: " + node.getTitle(),
    ...
    /**
     * This featured was moved from the LogBrokerMonitor class to the
     * CategoryNodeExplorer so that the Category tree could be pruned from the
     * Category Explorer popup menu. This menu option only appears when a user right
     * clicks on the Category parent node.
     *
