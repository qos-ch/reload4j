...
//    public static final String COMPACT_VIEW = "Compact";
    ...
    /**
     * Get the value of whether or not System.exit() will be called when the
     * LogBrokerMonitor is closed.
     */
    ...
    /**
     * Set the value of whether or not System.exit() will be called when the
     * LogBrokerMonitor is closed.
     */
    ...
    /**
     * Add a log record message to be displayed in the LogTable. This method is
     * thread-safe as it posts requests to the SwingThread rather than processing
     * directly.
     */
    ...
    /**
     * Check to see if the any records contain the search string. Searching now
     * supports NDC messages and date.
     */
    ...
    /**
     * When the fontsize of a JTextArea is changed, the word-wrapped lines may
     * become garbled. This method clears and resets the text of the text area.
     */
    ...
    /**
     * Changes the font selection in the combo box and returns the size actually
     * selected.
     * 
	...
	LogFactor5InputDialog inputDialog = new LogFactor5InputDialog(getBaseFrame(), "Set Max Number of Records", "",
		10);
	...
	if (temp != null) {
		...
		LogFactor5ErrorDialog error = new LogFactor5ErrorDialog(getBaseFrame(),
	...
	JOptionPane.showMessageDialog(_logMonitorFrame, _displayedLogBrokerProperties.toArray(), title,
	...
	editFindMI.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		String inputValue = JOptionPane.showInputDialog(_logMonitorFrame, "Find text: ",
			"Search Record Messages", JOptionPane.QUESTION_MESSAGE);
	...
	editSortNDCMI.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		String inputValue = JOptionPane.showInputDialog(_logMonitorFrame, "Sort by this NDC: ",
			"Sort Log Records by NDC", JOptionPane.QUESTION_MESSAGE);
...
//    }
    ...
    /**
     * Ensures that the Table's ScrollPane Viewport will "track" with updates to the
     * Table. When the vertical scroll bar is at its bottom anchor and tracking is
     * enabled then viewport will stay at the bottom most point of the component.
     * The purpose of this feature is to allow a developer to watch the table as
     * messages arrive and not have to scroll after each new message arrives. When
	...
	int value = JOptionPane.showConfirmDialog(_logMonitorFrame, message.toString(), title,
