 ...
 * Obvious implementations of these methods have been tried and failed.
 *
 * @author Richard Wan
 */
...
public class LF5SwingUtils {
    ...
    /**
     * Selects a the specified row in the specified JTable and scrolls the specified
     * JScrollpane to the newly selected row. More importantly, the call to
     * repaint() delayed long enough to have the table properly paint the newly
    ...
    /**
     * Makes the specified Adjustable track if the view area expands and the
     * specified Adjustable is located near the of the view.
     */
    ...
    /**
     * Makes the vertical scroll bar of the specified JScrollPane track if the view
     * expands (e.g. if rows are added to an underlying table).
     */
