 ...
 *
 * <p>
 * JMS {@link Topic topics} and {@link TopicConnectionFactory topic connection factories} are administered objects that
 * are retrieved using JNDI messaging which in turn requires the retrieval of a JNDI {@link Context}.
 *
 * <p>
 * There are two common methods for retrieving a JNDI {@link Context}. If a file resource named <em>jndi.properties</em>
 ...
 *
 * <p>
 * Calling the no-argument <code>InitialContext()</code> method will also work from within Enterprise Java Beans (EJBs)
 ...
 * separate JVM need to be concerned about the <em>jndi.properties</em> file and calling
...
public class JMSAppender extends AppenderSkeleton {
     ...
     * {@link TopicConnectionFactory#createTopicConnection(String, String) creating a topic session}. If you set this
