...
/**
 * Outputs the ThrowableInformation portion of the LoggingEvent. By default,
 * outputs the full stack trace. %throwable{none} or %throwable{0} suppresses
 * the stack trace. %throwable{short} or %throwable{1} outputs just the first
 * line. %throwable{n} will output n lines for a positive integer or drop the
 * last -n lines for a negative integer.
 *
 * @author Paul Smith
 *
 */
