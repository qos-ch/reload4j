...
/**
 * Formats an date by delegating to DatePatternConverter. The default date pattern for a %d specifier in a file name is
 * different than the %d pattern in pattern layout.
 *
 * @author Curt Arnold
 */
