...
public class LogEvent implements java.io.Serializable {
     ...
     * false when serialized. Thus, a receiving SocketNode will never use it's own (incorrect) NDC. See also writeObject
     * method.
     */
     ...
     * false when serialized. See also the getMDC and getMDCCopy methods.
     */
     ...
     *
     * <p>
     * Before serialization, the returned object is the message passed by the user to generate the logging event. After
     * serialization, the returned value equals the String form of the message possibly after object rendering.
     *
     * @since 1.1
     */
     ...
     *
     * <p>
     * Note that <em>both</em> the local MDC copy and the current thread's MDC are searched.
     */
     ...
     *
     * <p>
     * Note that the {@link Throwable} object contained within a {@link ThrowableInformation} does not survive
     * serialization.
     *
     * @since 1.1
     */
