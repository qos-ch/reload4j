...
public class LogEvent implements java.io.Serializable {
     ...
     * deserialization.
     * 
     * @deprecated This field will be marked as private or be completely removed in
     *             future releases. Please do not use it.
     */
     ...
     * 
     * @deprecated This field will be marked as private in future releases. Please
     *             do not access it directly. Use the {@link #getLoggerName} method
     *             instead.
     * 
     */
     ...
     *
     * @deprecated This field will be marked as private in future releases. Please
     *             do not access it directly. Use the {@link #getLevel} method
     *             instead.
     */
     ...
     * again. Note that its value is always false when serialized. Thus, a receiving
     * SocketNode will never use it's own (incorrect) NDC. See also writeObject
     * method.
     */
    ...
    /**
     * The application supplied message rendered through the log4j objet rendering
     * mechanism.
     */
     ...
     * 
     * <p>
     * Except {@link #timeStamp} all the other fields of <code>LoggingEvent</code>
     ...
     * @param throwable The throwable of this event.
     */
    public LogEvent(String fqnOfCategoryClass, Category logger, long timeStamp, Priority level, Object message,
	    Throwable throwable) {
	this.fqnOfCategoryClass = fqnOfCategoryClass;
	this.logger = logger;
	this.categoryName = logger.getName();
     ...
     */
    public LogEvent(final String fqnOfCategoryClass, final Logger logger, final long timeStamp, final Level level,
    ...
    /**
     * Return the name of the logger. Use this form instead of directly accessing
     * the <code>categoryName</code> field.
     */
     ...
     * 
     * <p>
     * Before serialization, the returned object is the message passed by the user
     * to generate the logging event. After serialization, the returned value equals
     * the String form of the message possibly after object rendering.
     * 
     * @since 1.1
     */
     ...
     * different machine. The {@link NDC#get} method should <em>never</em> be called
     * directly.
     */
    ...
    /**
     * Returns the the context corresponding to the <code>key</code> parameter. If
     * there is a local MDC copy, possibly because we are in a logging server or
     * running inside AsyncAppender, then we search for the key in MDC copy, if a
     * value is found it is returned. Otherwise, if the search in MDC copy returns a
     * null result, then the current thread's <code>MDC</code> is used.
     * 
     * <p>
     * Note that <em>both</em> the local MDC copy and the current thread's MDC are
     * searched.
     * 
     */
    ...
    /**
     * Returns the time when the application started, in milliseconds elapsed since
     * 01.01.1970.
     */
     ...
     * event. Access to the MDC is not synchronized, so this method should only be
     * called when it is known that no other threads are accessing the MDC.
     * 
     * @since 1.2.15
     * @param propName
     * @param propValue
     ...
     *
     * Equivalent to getMDC(String) in log4j 1.2. Provided for compatibility with
     * log4j 1.3.
     *
    ...
    /**
     * Getter for the event's time stamp. The time stamp is calculated starting from
     * 1970-01-01 GMT.
     * 
     * @return timestamp
     *
