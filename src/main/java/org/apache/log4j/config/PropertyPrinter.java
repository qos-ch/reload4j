 ...
 * auto-initialized) as a propoperties file on a {@link PrintWriter}.
 * 
...
public class PropertyPrinter implements PropertyGetter.PropertyCallback {
    ...
    /**
     * Returns true if the specified appender name is considered to have been
     * generated, that is, if it is of the form A[0-9]+.
     */
    ...
    /**
     * Prints the configuration of the default log4j hierarchy as a Java properties
     * file on the specified Writer.
     * 
     * <p>
