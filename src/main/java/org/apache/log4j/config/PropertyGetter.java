...
public class PropertyGetter {
     ...
     * {@link #getProperties(PropertyGetter.PropertyCallback, String)} one or more times.
     *
    ...
    protected boolean isHandledType(Class type) {
        return String.class.isAssignableFrom(type) || Integer.TYPE.isAssignableFrom(type) || Long.TYPE.isAssignableFrom(
                type) || Boolean.TYPE.isAssignableFrom(type) || Priority.class.isAssignableFrom(type);
    }
}
