...
abstract public class DateLayout extends Layout {
    ...
    /**
     * The value of the <b>DateFormat</b> option should be either an argument to the constructor of
     * {@link SimpleDateFormat} or one of the srings "NULL", "RELATIVE", "ABSOLUTE", "DATE" or "ISO8601.
     */
    ...
    /**
     * Sets the DateFormat used to format date and time in the time zone determined by <code>timeZone</code> parameter.
     * The {@link DateFormat} used will depend on the <code>dateFormatType</code>.
     *
     * <p>
